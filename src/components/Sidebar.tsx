    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed top-3 left-3 z-50 lg:hidden w-10 h-10 bg-white border border-gray-200 rounded-lg flex items-center justify-center shadow-sm hover:bg-gray-50 transition-colors"
            ...
            >
                ...
                <div className="px-4 pt-4 pb-2">
                    <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-lg text-gray-400 text-sm cursor-pointer hover:bg-gray-100 transition-colors">
                        ...
                        <span>Search...</span>
                        <kbd className="ml-auto text-[10px] bg-white border border-gray-200 rounded px-1.5 py-0.5 font-mono text-gray-400 hidden sm:inline">⌘K</kbd>
                    </div>
                </div>
